...
#ifndef SincityFramework_sc_display_osx_h
#define SincityFramework_sc_display_osx_h

#include "sc_config.h"

extern const struct tmedia_consumer_plugin_def_s *sc_display_osx_plugin_def_t;
